...
<section class='row content-row'>
  <div class='medium-12 columns' style='text-align: center'>
    <h5>Apply online!</h5>
    <a class='button' href='https://apply.unicamp.org/login/register/tbc18.1'>Register for July 11-13 &rarr;</a>
    <a class='button' href='https://apply.unicamp.org/login/register/tbc18.2'>Register for July 20-22 &rarr;</a>
    <a class='button' href='https://apply.unicamp.org/login/register/tbc18.3'>Register for August 12-14 &rarr;</a>
  </div>
  <div class='medium-6 columns'>
    ...
    <ul>
      <li><strong>July 11-13</strong> <a href='https://apply.unicamp.org/login/register/tbc18.1'>(register)</a> — after New Student Orientation (NSO) session 101.</li>
  ...
  <div class='medium-6 columns'>
    ...
    <ul>
      ...
      <li>Not in one of the New Student Orientation sessions that coincide with a True Bruin Camp session? You can still sign up for True Bruin Camp, but please note that you will not be able to change your NSO session date to coincide with the date of your True Bruin Camp. (Note: We can help arrange an extra night in Westwood before or after your NSO session if needed.)</li>
    </ul>
    <h5>Other info:</h5>
    <ul>
      <li>The cost for food, supplies, and transportation is $50 per student</li>
      <li>Transportation from UCLA to Camp River Glen and back is provided. The program starts once your New Student Orientation session concludes, around 6pm. We will be back at UCLA two days later around 5pm.</li>
      <li>Be sure to bring a sleeping bag, warm clothes, sunscreen, water bottle, and a flashlight</li>
    </ul>
    <p><strong>Questions? Email <a href='mailto:registration@unicamp.org'>registration@unicamp.org</a></strong></p>
  </div>
</section>
<?php get_footer(); ?>
