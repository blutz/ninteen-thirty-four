...
<section class='row content-row'>
  <div class='medium-12 columns'>
    ...
    <a class='button' href='https://goo.gl/forms/6jWgFcoy3T9DhkrB2' style='display: inline-block; margin: auto; font-size: 1.3rem; text-align: center; width: auto; position: relative; left: 50%; transform: translateX(-50%); '>Apply online! &rarr;</a>
  </div>
</section>
<?php get_footer(); ?>
