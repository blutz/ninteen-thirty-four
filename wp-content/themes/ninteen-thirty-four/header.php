...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$ninteen_thirty_four_description = get_bloginfo( 'description', 'display' );
			if ( $ninteen_thirty_four_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $ninteen_thirty_four_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
