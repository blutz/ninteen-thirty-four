...
class FrameComponent extends Component {
    ...
    render() {
        ...
        const borderStyles = {
            solid: __( 'Solid', 'ghostkit' ),
            dashed: __( 'Dashed', 'ghostkit' ),
            dotted: __( 'Dotted', 'ghostkit' ),
            double: __( 'Double', 'ghostkit' ),
            none: __( 'None', 'ghostkit' ),
        };
