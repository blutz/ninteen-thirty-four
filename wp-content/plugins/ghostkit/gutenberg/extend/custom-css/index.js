    ...
    getEditor() {
        ...
        return (
            <Fragment>
                ...
                <p dangerouslySetInnerHTML={ { __html: __( 'Use %s rule to change block styles.', 'ghostkit' ).replace( '%s', '<code>selector</code>' ) } } />
        ...
        return (
            <InspectorControls>
                ...
                >
                    ...
                    >
                        { __( 'Open in Modal', 'ghostkit' ) }
                    </Button>
                    { modalOpened ? (
                        <Modal
                            title={ __( 'Custom CSS', 'ghostkit' ) }
                            position="top"
                            size="md"
