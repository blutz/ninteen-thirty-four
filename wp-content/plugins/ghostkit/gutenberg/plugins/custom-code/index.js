                    ...
                    tabs={ [
                        {
                            name: 'local',
                            title: (
                                <Tooltip text={ __( 'All changes will be applied on the current page only.', 'ghostkit' ) }>
                                    <span>
                                        { __( 'Local', 'ghostkit' ) }
                                    </span>
                                </Tooltip>
                        ...
                        ( tabData ) => {
                            ...
                            return (
                                <Fragment>
                                    ...
                                    <p className="ghostkit-help-text">{ __( 'Add custom JavaScript code in <head> section or in the end of <body> tag. Insert Google Analytics, Tag Manager or other JavaScript code snippets.', 'ghostkit' ) }</p>
                                    <p>
