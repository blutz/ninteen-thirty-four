            ...
            <Fragment>
                <InspectorControls>
                    ...
                    <PanelBody title={ __( 'API Data', 'ghostkit' ) } initialOpen={ ! accessToken }>
                        ...
                        <p>
                            <em>
                                { __( 'A valid Access Token is required to use Instagram feed. How to get token', 'ghostkit' ) }
                                { ' ' }
                ...
                <div className={ className }>
                    ...
                    { ! accessToken ? (
                        <Placeholder
                            ...
                            instructions={ __( 'A valid Access Token is required to use Instagram feed. You can fill it in the block settings in Inspector.', 'ghostkit' ) }
                            className={ className }
                        />
                    ) : '' }
                </div>
