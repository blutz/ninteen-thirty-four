            ...
            <Fragment>
                <InspectorControls>
                    ...
                    <PanelBody title={ __( 'API Data', 'ghostkit' ) } initialOpen={ ! APIDataReady }>
                        ...
                        <p>
                            <em>
                                { __( 'A valid API data is required to use Twitter feed. How to get it', 'ghostkit' ) }
                                { ' ' }
                ...
                <div className={ className }>
                                    ...
                                    <div className="ghostkit-twitter-profile-name">
                                        <h2 className="ghostkit-twitter-profile-fullname">
                                            ...
                                            { twitterProfile.verified ? (
                                                <span className="ghostkit-twitter-profile-verified">{ __( 'Verified account', 'ghostkit' ) }</span>
                                            ) : '' }
                                        </h2>
                                                        ...
                                                        { showFeedName ? (
                                                            <div className="ghostkit-twitter-item-meta-name">
                                                                <ExternalLink href={ `https://twitter.com/${ item.user.screen_name }/` }>
                                                                    ...
                                                                    { ' ' }
                                                                    { item.user.verified ? (
                                                                        <span className="ghostkit-twitter-item-meta-name-verified">{ __( 'Verified account', 'ghostkit' ) }</span>
                                                                    ) : '' }
                                                                    { ' ' }
                                                                    <span>
                                                                        @
                    ...
                    { ! APIDataReady ? (
                        <Placeholder
                            ...
                            instructions={ __( 'A valid API data is required to use Twitter feed. You can fill it in the block settings in Inspector.', 'ghostkit' ) }
                            className={ className }
                        />
                    ) : '' }
                </div>
