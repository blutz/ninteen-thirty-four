...
const TEMPLATE = [
    ...
    [ 'ghostkit/form-field-text', { slug: 'field_subject', label: __( 'Subject', 'ghostkit' ), required: true } ],
    [ 'ghostkit/form-field-textarea', { slug: 'field_message', label: __( 'Message', 'ghostkit' ), required: true } ],
            ...
            <Fragment>
                <InspectorControls>
                    ...
                    <PanelBody title={ __( 'Confirmation', 'ghostkit' ) }>
                        <BaseControl label={ __( 'Type', 'ghostkit' ) }>
                            <br />
                            <ButtonGroup>
                                {
                                    [
