                            ...
                            { ( { onClose } ) => (
                                <MenuGroup>
                                    ...
                                    >
                                        ...
                                        <span className="ghostkit-typography-badge-pro">{ __( 'PRO', 'ghostkit' ) }</span>
                                    </MenuItem>
                                </MenuGroup>
                            ) }
                        </DropdownMenu>
                    ...
                    <ApplyFilters name="ghostkit.typography.fontFamilySelector.info" props={ this.props }>
                        { 'adobe-fonts' === fontFamilyCategory ? (
                            <div className="ghostkit-typography-information-control ghostkit-typography-font-control">
                                { __( 'Adobe Fonts available for PRO users only. Read more about Ghost Kit PRO plugin here - ', 'ghostkit' ) }
