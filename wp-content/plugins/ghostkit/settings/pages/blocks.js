    ...
    render() {
        ...
        Object.keys( blocks ).forEach( ( name ) => {
            ...
            resultBlocks.push(
                ...
                >
                    ...
                    <Tooltip text={ this.getDisabledBlock( block ) ? __( 'Enable Block', 'ghostkit' ) : __( 'Disable Block', 'ghostkit' ) }>
        ...
        categories.forEach( ( cat ) => {
            ...
            if ( disabledCurrentCount ) {
                resultTabs.push(
                    <Tooltip text={ sprintf( __( 'Disabled Blocks: %s', 'ghostkit' ), disabledCurrentCount ) } key="tab-disabled-blocks">
                        { categoryContent }
                    </Tooltip>
                );
            } else {
                    ...
                    <div className="ghostkit-settings-blocks-right">
                        { count ? (
                            <div className="ghostkit-settings-blocks-items-head">
                                ...
                                <Tooltip text={ disabledCount !== count ? __( 'Disable All Blocks', 'ghostkit' ) : __( 'Enable All Blocks', 'ghostkit' ) }>
                                    <div
                                        className={
                                            classnames(
