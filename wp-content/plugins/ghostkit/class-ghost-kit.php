...
class GhostKit {
    ...
    public function js_translation() {
        ...
        wp_set_script_translations( 'ghostkit-editor', 'ghostkit', basename( dirname( __FILE__ ) ) . '/languages' );
        wp_set_script_translations( 'ghostkit-settings', 'ghostkit', basename( dirname( __FILE__ ) ) . '/languages' );
    }
                ...
                'customTypographyList' => is_admin() ? apply_filters(
                    'gkt_custom_typography', array(
                         ...
                         * Example:
                            array(
                                'titles' => array(
                                    'label' => esc_html__( 'Titles', 'ghostkit' ),
                                    'defaults' => array(
