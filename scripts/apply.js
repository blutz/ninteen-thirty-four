...
var SESSION_INFO = {
  'session3': {
    ...
    'googleFormId': '1y_SKQ5A592-1PEa8f61GXdjEXj8CG_RU9BB74yyNqr4'
  },
  'session6-chla': {
    'title': 'Session 6: Healthy Lifestyles',
    'subtitle': "Children's Hospital Los Angeles",
    //'googleFormId': '1uMB3YMnie2Pt3QibExqsN-SY1xqc3saJrR5cafvLBhQ',
    'airtableFormId': 'shr18CTJZ0sq4S3c2',
  ...
  'session6-open': {
    ...
    'subtitle': "Children's Hospital Los Angeles",
    //'googleFormId': '1uMB3YMnie2Pt3QibExqsN-SY1xqc3saJrR5cafvLBhQ',
    'airtableFormId': 'shrYj8OLuJrenzwIS',
  ...
  'session5': {
    ...
    'googleFormId': '1AYFH-5TWtPI3UQKPMFdrde78M2PooXKvLCzZjkYgRXc',
  ...
  'ocp': {
    ...
    'googleFormId': '1_sNmfTQHHfp9ZIDFgjbjD2m0tH66TG5QcLtjUc_P5wo'
  }
}
...
function draw(context) {
  ...
  // Details section
    ...
    if (context.sessionDetails.googleFormId) {
      var formUrl = 'https://docs.google.com/forms/d/' + context.sessionDetails.googleFormId + '/viewform?embedded=true'
    } else if (context.sessionDetails.airtableFormId) {
      var formUrl = 'https://airtable.com/embed/' + context.sessionDetails.airtableFormId + '?backgroundColor=cyan'
    }
